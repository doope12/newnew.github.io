...
const userNickname = document.querySelector(".profile__name");
const userBalance = document.querySelector(".profile__balance");
const countItemsAmount = Object.keys(allItems).length;
const itemsBox = document.querySelector(".profile__items-box");
const totalValueOfSkins = document.querySelector(".profile__items-value");
const avatarInput = document.querySelector(".profile__input--avatar");
const nicknameInput = document.querySelector(".profile__input--nickname");
...
const statsUpgrader = document.querySelector(
	".profile__stats-amount--upgrader"
);
const statsRoulette = document.querySelector(
...
const addEventListeners = () => {
	...
	const sellItemBtns = document.querySelectorAll(".profile__item-btn");
